...
public class TwitterProducer {
    ...
    List<String> terms = Lists.newArrayList("covid", "bolsonaro", "soccer");
//    List<String> terms = Lists.newArrayList("kafka");
    ...
    public void run() {
        ...
        while (!client.isDone()) {
            ...
            try {
                ...
                logger.error("Error while polling msgQueue", e);
                client.stop();
            }
    ...
    private KafkaProducer<String, String> createKafkaProducer() {
        ...
        properties.setProperty( ProducerConfig.ACKS_CONFIG, "all"); // This is equivalent to the acks=-1 setting.
        properties.setProperty( ProducerConfig.RETRIES_CONFIG, Integer.toString(Integer.MAX_VALUE));
        properties.setProperty( ProducerConfig.MAX_IN_FLIGHT_REQUESTS_PER_CONNECTION, "5"); // kafka 2.0 >= 1.1 we can keep this as 5. Use 1 otherwise
